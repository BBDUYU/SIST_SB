...
public class BoardController {
    ...
    public String detail(@PathVariable("postId") Long postId, Model model, Principal principal) {
    ...
    public String writeSubmit(@ModelAttribute("dto") BoardDTO dto) {
        Long id = boardService.create(dto);
        return "redirect:/board/" + id;
    }

    @GetMapping("/board/{postId}/edit")
    public String edit(@PathVariable("postId") Long postId, Model model, Principal principal) {
        model.addAttribute("isLogin", principal != null);
    ...
    public String editSubmit(@PathVariable("postId") Long postId, @ModelAttribute("dto") BoardDTO dto) {
    ...
    public String addReply(@PathVariable("postId") Long postId,
        ...
        boardService.addReply(postId, content);
        return "redirect:/board/" + postId;
    }
}